...
| Page | URL | Status | Notes |
|---|---|---|---|
| Blog Hub | https://musicofthe70s.net/blog/index.html | Live | Nav note below the 9-card Latest Posts row: real total (51) + rotation notice + link to the site-wide archive. As of 2026-08-24: Dolly Parton, Stevie Wonder, We Will Rock You, Brian May and Queen, Iggy Pop, ABBA vs Queen, Gimme Gimme Gimme, Benny Andersson, and Anni-Frid Lyngstad are on the row; Bjorn Ulvaeus rolled off, on top of every drop already logged in Session Log entries above. |
...
| Artists category | https://musicofthe70s.net/blog/artists/index.html | Live | Shows the 6 most recent of 16 real posts (Dolly Parton, Stevie Wonder, Brian May and Queen, Iggy Pop, Benny Andersson, Anni-Frid Lyngstad kept as of 2026-08-24, rest in archive); nav note + archive link below the grid. Auto-generated by `scripts/generate_category_cards.py`. |
| Artists archive | https://musicofthe70s.net/blog/artists/archive/index.html | Live | Lists all 11 Artists posts, reverse chronological, auto-generated. |
...
|---|---|---|---|---|---|---|
| Dolly Parton: The Split, the Songs, and the Lawsuit | https://musicofthe70s.net/blog/artists/dolly-parton/index.html | Artists | dolly parton | Live | 2026-08-24 | Random Artist Picker, 70s Music Trivia Quiz |
...
- Total published blog posts: 51 (all confirmed Live: Genres 12, Artists 16, Songs 9, Trivia 4, Years 10) — recounted directly from the table above 2026-08-24 (Dolly Parton landed this session, first Artists post under the new genre-rotation rule)
