...
| Page | URL | Status | Notes |
|---|---|---|---|
| Blog Hub | https://musicofthe70s.net/blog/index.html | Live | Nav note below the 9-card Latest Posts row: real total (66) + rotation notice + link to the site-wide archive. As of 2026-09-01: Killer Queen, Donna Summer, ABBA Waterloo, How Can You Mend a Broken Heart, Al Green, Marvin Gaye, Rick James, Bridge Over Troubled Water, and I Will Survive are on the row; Seasons in the Sun rolled off, on top of every drop already logged in Session Log entries above. |
| Blog Archive | https://musicofthe70s.net/blog/archive/index.html | Live | Lists all 35 posts across every category, reverse chronological, auto-generated by `scripts/generate_blog_hub_cards.py`. |
...
| Songs category | https://musicofthe70s.net/blog/songs/index.html | Live | Shows the 6 most recent of 16 real posts as of 2026-09-01 (Killer Queen, ABBA Waterloo, How Can You Mend a Broken Heart, Bridge Over Troubled Water, I Will Survive, Seasons in the Sun); rest in the Songs archive. |
...
|---|---|---|---|---|---|---|
| One of These Nights: The Eagles' Turn Away From Country | https://musicofthe70s.net/blog/songs/one-of-these-nights/index.html | Songs | one of these nights | Built-Local | (pending review) | Random 70s Song Generator, Mood Song Matcher |
...
- Total published (reviewed and pushed) blog posts: 66 (Genres 12, Artists 24, Songs 16, Trivia 4, Years 10, as of 2026-09-01). Killer Queen (Songs, third entry in the artist-linked rotation queue) published 2026-09-01, approved and pushed same session, verified stable on two consecutive live fetches post-deploy
- Total placeholder/in-progress posts: 1 — One of These Nights (Songs, artist-linked rotation queue slot #4, Eagles) Built-Local 2026-09-01, verified locally, awaiting Charlie's review per Publish Gate
