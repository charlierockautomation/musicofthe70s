...
| Page | URL | Status | Notes |
|---|---|---|---|
| Blog Hub | https://musicofthe70s.net/blog/index.html | Live | Nav note below the 9-card Latest Posts row: real total (44) + rotation notice + link to the site-wide archive. As of 2026-08-20: Gimme Gimme Gimme, Benny Andersson, Anni-Frid Lyngstad, Bjorn Ulvaeus, Agnetha Fältskog, 70s Folk Rock, 70s Progressive Rock, Mamma Mia Song, and Take It Easy are on the row; 70s Punk Rock rolled off, on top of every drop already logged in Session Log entries above. |
...
| Artists category | https://musicofthe70s.net/blog/artists/index.html | Live | Shows the 6 most recent of 11 real posts (Village People, Bee Gees, Talking Heads, James Brown in the 70s, and Grateful Dead in the 70s all rolled off as of 2026-08-18); nav note + archive link below the grid. |
...
| Trivia category | https://musicofthe70s.net/blog/trivia/index.html | Live | **Updated 2026-08-21.** Now shows all 4 posts (at the 4 cap, no drop yet) after ABBA vs Queen was added. |
