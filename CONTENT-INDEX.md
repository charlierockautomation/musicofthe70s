...
| Page | URL | Status | Notes |
|---|---|---|---|
| Blog Hub | https://musicofthe70s.net/blog/index.html | Live | Nav note below the 9-card Latest Posts row: real total (62) + rotation notice + link to the site-wide archive. As of 2026-08-30: Al Green, Marvin Gaye, Rick James, Bridge Over Troubled Water, I Will Survive, Seasons in the Sun, Stayin Alive, George Clinton, and Jim Croce are on the row; Carole King rolled off, on top of every drop already logged in Session Log entries above. |
...
- Total published blog posts: 62 (Genres 12, Artists 23, Songs 13, Trivia 4, Years 10, per `scripts/generate_category_cards.py` and `scripts/generate_llms_txt.py` disk counts 2026-08-30) — Al Green built this session, second Artists post in the soul bucket after Marvin Gaye
- Total placeholder/in-progress posts: 0
- Placeholder card slots remaining on category pages: 0
- Last full site audit: 2026-08-22 (sitemap.xml cross-check, confirmed 67 total live URLs = 9 + 11 + 47). Table-recount total is now 9 + 11 + 62 = 82 as of 2026-08-30, not yet re-verified against a fresh live sitemap crawl
