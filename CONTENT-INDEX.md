...
# Last Updated: 2026-07-29 (70s Soul Music post built, second Genres post, pending approval/push)
...
| 70s Soul Music: The Artists Who Redefined a Genre | https://musicofthe70s.net/blog/genres/70s-soul-music/index.html | Genres | 70s soul music | Built-Local | ~1,208 | Pending | 2026-07-29 | Random Artist Picker, Random 70s Song Generator | Second Genres post. Multi-source NotebookLM notebook (playlist page, "100 Soul Songs" list, YouTube video), not single-source; every fact attributed to Source 1 or Source 2 specifically per the task brief, nothing blended across sources, no conflicts found. A Source 3 "quote" was actually song lyrics (Harold Melvin & The Blue Notes' "Wake Up Everybody") and was excluded entirely, not paraphrased, not referenced by title with lyric text; confirmed absent from final HTML (checked programmatically). The two legitimate source quotes (soul reaching "new ambitions," a "golden era") were paraphrased rather than quoted directly, per instruction. Caught and fixed one CLAUDE.md violation in the source draft before publishing: FAQ answer 4 opened with a bare "Yes." which the AI Answer Engine rule explicitly disallows ("never opens with 'Yes' or 'No' alone"); rewrote to restate the fact first. Wrote short sentences from the start this time instead of a rewrite pass (lesson from the 1971 post): only 3 sentences came in at exactly 20 words, fixed by trimming/splitting, now 100% of body sentences under 20 words (verified programmatically; one 40-word "long" flag is the Related Posts card blurb, reused verbatim from the live 70s Rock post, not body prose, consistent with site convention). Keyword density 0.828% (10 uses / 1,208 words), within 0.5%-2% range, never in consecutive sentences (verified). FAQPage schema verified word-for-word identical to visible FAQ block for all 5 entries (verified programmatically). Word count was 1,171 on first draft, under the 1,200 minimum; added 3 short natural sentences (not padding) to reach 1,208. Featured image source file was misnamed in staging (missing leading "7": "0s-soul-music-infographic.png"), visually confirmed content matched the brief before use, renamed correctly on move. Related Posts block: single card for 70s Rock, the only other Live Genres post. Added 2nd card to Genres category page and 7th card to Blog Hub's "Latest Posts" row (no open placeholder slot existed there, unlike the 1971 post). No Planned-table row existed for this post, added directly per task instruction. Status will move to Live only after local preview, mobile check, explicit approval, and post-push live verification. |
...
| Top Songs of 1972 through 1979 (8 more) | /blog/years/top-songs-of-19[72-79]/ | Years | top songs of 19[XX] |
...
- Total published blog posts: 6 (all confirmed Live), plus 1 Built-Local pending approval/push (70s Soul Music)
- Total placeholder/in-progress posts: 1 (70s Soul Music, awaiting approval)
