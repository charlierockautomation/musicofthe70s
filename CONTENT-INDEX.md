...
| Page | URL | Status | Notes |
|---|---|---|---|
| Blog Hub | https://musicofthe70s.net/blog/index.html | Live | Nav note below the 9-card Latest Posts row: real total (61) + rotation notice + link to the site-wide archive. As of 2026-08-29: Marvin Gaye, Rick James, Bridge Over Troubled Water, I Will Survive, Seasons in the Sun, Stayin Alive, George Clinton, Jim Croce, and Carole King are on the row; Willie Nelson rolled off, on top of every drop already logged in Session Log entries above. |
...
| Artists category | https://musicofthe70s.net/blog/artists/index.html | Live | Shows the 6 most recent of 22 real posts as of 2026-08-29 (Marvin Gaye, Rick James, George Clinton, Jim Croce, Carole King, Willie Nelson), rest in archive; nav note + archive link below the grid. Auto-generated by `scripts/generate_category_cards.py`. |
| Artists archive | https://musicofthe70s.net/blog/artists/archive/index.html | Live | Lists all 22 Artists posts, reverse chronological, auto-generated. |
...
- Total published blog posts: 60 (Genres 12, Artists 21, Songs 13, Trivia 4, Years 10, per `scripts/generate_category_cards.py` and `scripts/generate_llms_txt.py` disk counts 2026-08-29) — Rick James built this session, first Artists post to land after George Clinton/Jim Croce; Songs/Artists counts here were stale pending Charlie's approval to push (prior line hadn't been updated since the 2026-08-28 Songs batch or George Clinton), corrected against actual generator output rather than recounted by hand
