...
# Last Updated: 2026-08-06 (Village People in the 70s marked Live, third post of the approved Artists batch)
...
**Artists** — batch of 4 approved (James Brown, Grateful Dead, Village People, Talking Heads), sourced from the 619-artist JSON across 10 genre files, spanning 4 distinct genres by design. KC and the Sunshine Band was considered and dropped from the batch, not for lack of substance but over a real JSON data error found in its trivia field (see Session Log below). James Brown in the 70s, Grateful Dead in the 70s, and Village People in the 70s are all Live (2026-08-06), 3 of 4 posts in the batch. Talking Heads remains to be built, the last entry in this round. Artists category page has had zero placeholder slots since the Grateful Dead post; Village People was appended as a straight 4th card instead.
