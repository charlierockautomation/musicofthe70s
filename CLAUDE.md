...
# Last Updated: 2026-08-06 (Top Songs of 1979 marked Live, Years series complete)
...
**The Years series is complete: all ten posts (1970, plus Order #1-9 for 1971-1979) are Live.** Top Songs of 1970 predates Order numbering (see note above) but is Live alongside the rest. No further Years posts are planned. What content type comes next has not been decided; see the Series Wrap-Up entry in the Session Log below.
