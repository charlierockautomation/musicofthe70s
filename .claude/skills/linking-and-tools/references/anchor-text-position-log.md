...
Rule: before placing any internal link, check the last 3-5 rows for the same
category. Anchor text AND position must not repeat within that window. Anchor
text = brand phrase "Music of the 70s" OR the target's own focus keyword, never
generic. Log new entries here after placing links. Log starts 2026-08-28; prior
...
| Bad Girls | Songs | Donna Summer (artist) | /blog/artists/donna-summer/index.html | Body, "A Song Built on Compassion, Not Judgment" H3, mid-section |
| Bad Girls | Songs | Donna Summer Hot Stuff (song) | /blog/songs/donna-summer-hot-stuff/index.html | Body, "Written With the Men Who Became Her In-Laws" H2, closing-area sentence, song-to-song cross-link |
| Bad Girls | Songs | Bad Girls (Listen Now) | /radio/index.html?play=1979-2-bad-girls | Body, "A Romance That Started in the Same Sessions" H3, mid-section, not adjacent to the video embed |
| Bad Girls | Songs | Random 70s Song Generator | /pages/random-70s-song.html | Body, opening sentence of the "Where the Song Landed on the Charts" H2 |
| Bad Girls | Songs | Mood Song Matcher | /pages/mood-song-matcher.html | Body, opening sentence of the "The Grammy It Didn't Win" H2 |
...
| Flash Light Parliament | Songs | George Clinton (artist) | /blog/artists/george-clinton/index.html | Body, "Bootsy Ended Up on Drums Instead" H3, mid-section sentence |
| Flash Light Parliament | Songs | Give Up the Funk Parliament (song) | /blog/songs/give-up-the-funk-parliament/index.html | Body, "Parliament's First Real Crossover Hit" H2, mid-section, song-to-song cross-link |
| Flash Light Parliament | Songs | Random 70s Song Generator | /pages/random-70s-song.html | Body, "A Bigger Hit on Black Radio Than Pop Radio" H3, closing sentence |
| Flash Light Parliament | Songs | Flash Light (Listen Now) | /radio/index.html?play=1978-92-flash-light | Body, opening sentence right after the video embed, adjacent-after |
