...
|---|---|---|
| Bohemian Rhapsody | Queen bio | Artists |
| Bohemian Rhapsody | A Glam or Prog Rock genre post | Genres |
| Hotel California | Eagles bio | Artists |
| Hotel California | Soft Rock or Yacht Rock genre post | Genres |
...
|---|---|---|---|
| 1 | Genres | 70s Soft Rock (69 real artists to draw from; keyword volume as supplied by Charlie, 14,800/mo — not independently reverified in the 2026-08-09 audit, re-check before writing) | pending |
| 2 | Artists | Queen (closes Bohemian Rhapsody link-owed gap) | pending keyword check |
| 3 | Genres | Country Rock of the 70s (100 artists, the single largest genre bucket in the real data — not on the original plan, surfaced by the audit) | pending keyword check |
| 4 | Genres | Disco Music of the 70s (already Planned, keyword already set, 65 real artists, Dancing Queen and Village People both waiting to link to it) | pending |
| 5 | Artists | Eagles (closes Hotel California link-owed gap; verify NFL-team search ambiguity first) | pending keyword check |
| 6 | Genres | 70s Hard Rock (68 artists) | pending keyword check |
| 7 | Artists | ABBA (closes Dancing Queen link-owed gap) | pending keyword check |
| 8 | Genres | Classic Rock of the 70s (66 artists — CHECK FIRST whether this genuinely differs from the already-live "70s Rock" post or is a data-labeling overlap before building; don't duplicate) | needs a content decision, not just a keyword check |
| 9 | Trivia | Next Trivia post drawing from the untapped 50-question QUIZ_POOL in js/quiz-questions.js | needs a content decision on format |
| 10 | Genres | 70s Funk (50 artists; check against the live Soul post for overlap first) | pending keyword check |
| 11 | Genres | Progressive Rock in the 70s (50 artists; fold in "concept albums" as a section) | pending keyword check |
| 12 | Genres | Pop Crossover of the 70s (50 artists — decide if this is distinct from Soft Rock/Yacht Rock or overlapping before building) | needs a content decision |
| 13 | Genres | 70s Punk Rock (real count closer to 23 once new-wave contamination is filtered out; can't lean on chart-hit hooks, zero punk songs in the chart data) | pending keyword check |
| 14 | Genres | Glam Rock in the 70s (no dedicated bucket — must be manually curated from hard-rock's 10 and pop-crossover's 7 subgenre-tagged artists) | needs manual curation before writing, not a simple pull |
...
| Artists | 5 | Next batch should prioritize Queen/Eagles/ABBA for the link-owed gaps |
| Trivia | 2 | Real untapped data exists (50-question pool), needs a format decision |
| Genres | 2 live + 1 Planned | The real gap — now backed by real per-genre artist counts above |
